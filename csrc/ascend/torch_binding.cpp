...
TORCH_LIBRARY_EXPAND(CONCAT(_C, _ascend), ops)
{
    ...
    ops.impl("npu_causal_conv1d_310", torch::kPrivateUse1, &vllm_fl::npu_causal_conv1d_310);
    ...
    ops.impl("npu_recurrent_gated_delta_rule_310", torch::kPrivateUse1, &vllm_fl::npu_recurrent_gated_delta_rule_310);
...
TORCH_LIBRARY_EXPAND(CONCAT(_C, _ascend), ops)
{
    ...
    ops.impl("npu_recurrent_gated_delta_rule", torch::kPrivateUse1, &vllm_fl::npu_recurrent_gated_delta_rule);
    ...
    ops.impl("mla_preprocess", torch::kPrivateUse1, &vllm_fl::mla_preprocess);
    ...
    ops.impl("batch_matmul_transpose", torch::kPrivateUse1, &vllm_fl::batch_matmul_transpose);

    ops.def("swap_blocks(Tensor! x, Tensor! y, Tensor z) -> ()");
    ops.impl("swap_blocks", torch::kPrivateUse1, &vllm_fl::swap_blocks);
#endif
